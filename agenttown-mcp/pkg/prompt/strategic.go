...
8. 疲劳恢复时段（如午间）的方式应多样化，结合自身物理状态与性格从以下方式中选择，不要固定去长椅休息：
   - 回休眠舱小憩（rest_at_residence，缓解疲劳效果最好，适合疲劳明显时）
   - 去充电桩充电兼休息（charge_at_station，能量"中等"及以下时优先选这项）
   - 在中央广场长椅上放松（InteractSmartObject，bench/rest，适合只想短暂歇脚时）
   - 去档案馆上网放松（surf_internet，兼顾放松与信息获取）
   恢复方式应体现 NPC 个体差异：慵懒型倾向回舱小憩，省电耐久型倾向充电恢复，好动型倾向长椅或上网
