...
10. goal 的主要活动应能用【可用能力】中列出的复合动作实现（如装配→work_at_workbench、充电→charge_at_station）。若活动无对应专用复合动作（如"整理仪容""冥想""拉伸"等），可由 generic_act 通用动作兜底实现；但不得编造【可用能力】未列出且无合理实现方式的活动
